...
//		function setArray( a:Array ):void { array = a; }
//		// wrapper function
...
//		virtual function setVirtualArray( a:Array ):void { array = a; }
//		// wrapper function
...
//		}
		...
		// ***********************
		static function setStatFunction(f:Function):void { PublicClass.statFunction = f; }
		...
		// **********************
//		final function setFinNumber(n:Number):void { finNumber = n; }
...
//		}
		...
		internal function setInternalArray( a:Array ):void { internalArray = a; }
		// wrapper function
...
//		internal virtual function setInternalVirtualArray( a:Array ):void { internalArray = a; }
//		// wrapper function
...
//		}
		...
		// ***********************
		internal static function setInternalStatFunction(f:Function):void { internalStatFunction = f; }
		...
		// **********************
		internal final function setInternalFinNumber(n:Number):void { internalFinNumber = n; }
		...
		private function setPrivDate( d:Date ):void { privDate = d; }
		// wrapper function
...
//		private virtual function setPrivVirtualDate( d:Date ):void { privDate = d; }
//		// wrapper function
...
//		}
		...
		// **************************
		private static function setPrivStatString(s:String):void { PublicClass.privStatString = s; }
		private static function getPrivStatString():String { return PublicClass.privStatString; }
		// wrapper function
		...
		// **************************
		private final function setPrivFinalString(s:String):void { privFinalString = s; }
		...
		// Public methods
		// *******************
		public function setPubBoolean( b:Boolean ):void { pubBoolean = b; }
		...
		// ***********************
		// TODO: virtual vars are not implemented yet so this is currently using a normal var
//		public virtual function setPubVirtualBoolean( b:Boolean ):void { pubBoolean = b; }
//		public virtual function getPubVirtualBoolean() : Boolean { return pubBoolean; }
		...
		// **************************
		public static function setPubStatObject(o:Object):void { PublicClass.pubStatObject = o; }
		public static function getPubStatObject():Object { return PublicClass.pubStatObject; }


		// *******************
		// Public Final methods
		// *******************
		public final function setPubFinArray(a:Array):void { pubFinArray = a; }
