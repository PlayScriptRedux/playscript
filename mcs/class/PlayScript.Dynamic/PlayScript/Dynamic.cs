...
namespace PlayScript
{
	public static class Dynamic
	{
		...
		public static bool GetPropertyOrField(object o, string name, out object value)
		{
			var type = o.GetType();
			...
			if (prop != null) {
				var getter = prop.GetGetMethod();
				if (getter == null) {
					getter = Dynamic.FindPropertyGetter(type, name);
				}
		...
		public static bool SetPropertyOrField(object o, string name, object value)
		{
			var type = o.GetType();
		...
		public static bool GetStaticPropertyOrField(Type type, string name, out object v)
		{
		...
		public static bool SetStaticPropertyOrField(Type type, string name, object v)
		{
			var property = type.GetProperty(name);
			if (property != null) {
