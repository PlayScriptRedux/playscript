...
namespace Mono.CSharp
{
	...
	public class SourceFile : IEquatable<SourceFile>
	{
		...
		// AS Support
		public SourceFileType FileType; // FileType is ActionScript or CSharp
		public bool AsExtended;  		// Allow ActionScript Extended Syntax (C# constructs/types)
		...
		public SourceFile (string name, string path, int index)
		{
			...
			if (ext.ToLower() == ".as") {
				FileType = SourceFileType.ActionScript;
				AsExtended = false;
			} else if (ext.ToLower() == ".asx") {
				FileType = SourceFileType.ActionScript;
				AsExtended = true;
			} else {
